...
class Migrator:
    ...
    def pr_body(
        ...
        body += (
            "<sub>"
            "This PR was created by the [conda-forge-bot](https://github.com/conda-forge/conda-forge-bot). "
            "The **conda-forge-bot** is a service to automatically "
            ...
            "[issues](https://github.com/conda-forge/conda-forge-bot/issues)! "
    ...
    def pr_title(self, feedstock_ctx: FeedstockContext) -> str:
        """Get the PR title."""
        return "PR from conda-forge-bot"
